...
% \title{Accelerating the Learning of Robotic Manipulation of Cloth} 
% \title{Learning Reward Functions for Learning Robotic Manipulation of Cloth} 
\title{Accelerating Deep Reinforcement Learning of Robotic Manipulation of Cloth} 
\def\thetitleNL{Methodes voor het Accelereren van Versterkingsgebaseerd Leren Vouwen van Kledij met Robots}
...
\newcommand{\chapterbookmarkcolor}{ColorAccent2}
