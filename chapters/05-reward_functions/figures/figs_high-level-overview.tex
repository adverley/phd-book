...
\tikzstyle{block} = [rectangle, draw, fill=blue!10, text width=17.5em, text centered, rounded corners, minimum height=2em]
\tikzstyle{dataset} = [cylinder, draw,  shape border rotate=90, fill=blue!10, text width=2.5cm, text centered, rounded corners, minimum height=1cm,minimum width=1cm, shape aspect=0.1]
