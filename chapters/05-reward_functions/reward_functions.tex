...
\note{Eigenlijk mag dit verwerkt worden in de volgende sectie. Het doel is TCNs voor te stellen, waarom we die gebruiken voor dit specifiek probleem maar wat ook de tekortkomingen zijn (ie. trajectory in embd space volgen) }
