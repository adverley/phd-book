...
\setlaymanexpl{Robotic manipulation of clothing present challenges we need to solve in order to build general-purpose robots.}
...
On the contrary, if the handle is highly deformable, you also need to reason about its shape and how it will deform as a result of the planned manipulation. Unfortunately, planning for deformations is not part of traditional robotic control pipelines.
