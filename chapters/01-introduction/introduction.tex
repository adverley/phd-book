...
\setlaymanexpl{Robotic manipulation of clothing, and other deformable objects, present challenges we need to solve in order to build general-purpose robots.}
