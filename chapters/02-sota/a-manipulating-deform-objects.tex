...
\subsection{Cloth folding pipelines} \label{subsec:lit_cloth_folding_pipelines}
...
\todo{deze paragraaf mag weg als je de structuur een niveau naar boven duwt}
