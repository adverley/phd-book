...
\begin{tikzpicture}[node distance = 10em, auto, thick]
    ...
    \draw [rectangle connector=-0.5cm] (env.west) to node[descr,align=center, pos=1,xshift=-2.5cm,yshift=-3.0cm] {\textcolor{ColorAccent1Strong}{State $s_{t}$}\\\includegraphics[width=2.5cm, height=2.0cm]{\home/chapters/02-sota/figures/DRL-in-robotics-2.png}} (agent.west);
