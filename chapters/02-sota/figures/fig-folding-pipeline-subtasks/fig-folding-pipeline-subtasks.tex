...
\begin{tikzpicture}
    ...
    \node[picture] (obs_pic) [right of=obs] {\includegraphics[width=\picMinWidth, height=\picMinHeight]{\home/chapters/02-sota/figures/fig-folding-pipeline-subtasks/isolate}}
    ...
    \node[picture] (state_pic) [right of=state] {\includegraphics[width=\picMinWidth, height=\picMinHeight]{\home/chapters/02-sota/figures/fig-folding-pipeline-subtasks/unfolding}}
    ...
    \node[picture] (modeling_pic) [right of=modeling] {\includegraphics[width=\picMinWidth, height=\picMinHeight]{\home/chapters/02-sota/figures/fig-folding-pipeline-subtasks/flattening}}
    ...
    \node[picture] (planning_pic) [right of=planning] {\includegraphics[width=\picMinWidth, height=\picMinHeight]{\home/chapters/02-sota/figures/fig-folding-pipeline-subtasks/folding}}
    ...
    \node[picture] (control_pic) [right of=control] {\includegraphics[width=\picMinWidth, height=\picMinHeight]{\home/chapters/02-sota/figures/fig-folding-pipeline-subtasks/stacking}}
