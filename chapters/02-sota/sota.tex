...
Existing simulations:
	SoftGym
	DeformableRavens~\autocite{seita2021learning} allows simulating robotic interaction with ropes, fabrics and bags. Unfortunately, the visual and physical fidelity is  significantly lower compared to other synthetic data.  
	DEDO [Antonova]
	PlasticineLab based on difftaichi
