...
After defining a shape representation for the deformable object, a dynamics model has to be implemented in order to calculate the deformations caused by the forces exerted on the object on interaction.
