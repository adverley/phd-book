...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=My titleeee]
...
\begin{tcolorbox}[
    ...
    title=My title can become long,
    fonttitle=\bfseries,
...
% \begin{keyMessageBox}{Supervised learning}{
    % Supervised learning involves learning to predict an output $y$, provided by the supervisor, from input data $x$.}
% \end{keyMessageBox}
\key{Supervised learning involves learning to predict an output $y$, provided by the supervisor, from input data $x$.}

\keyWithTitle{Supervised learning}{Supervised learning involves learning to predict an output $y$, provided by the supervisor, from input data $x$.}
